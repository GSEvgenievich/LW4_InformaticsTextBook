...
public partial class InformaticTextBookContext : DbContext
{
    public InformaticTextBookContext()
    {
    }

    public InformaticTextBookContext(DbContextOptions<InformaticTextBookContext> options)
        : base(options)
    {
    }
